...
def test_callback_action(mocker, tmp_path, fake_trainer, fake_batch, fake_pl_module):
    ...
    callback.on_train_batch_end(fake_trainer, fake_pl_module, fake_batch, batch_idx, dataloader_idx)
...
def test_callback_classes(mocker, tmp_path, fake_trainer, fake_batch, fake_pl_module, classes):
